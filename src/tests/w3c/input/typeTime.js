		...
		tests:[
			{
				...
				//
				id:100,
				name:"Verify time input interface.",
			...
			}, 
			{
				...
				test:function(t){
					dohx.showInfo('<form><input  id="_input400" type="time" /></form>');
...
// This test case doesnt work on a device where you get a date selector (opera, bb), there is no way to enter "abc" ... is this test obsolete?
		/*{
				...
				test:function(t){
					dohx.showInfo('<form id="_form1500"><input type="time" /><input type="submit" /></form>');
			...
			},*/
			{
				...
				expectedResult: "Do you NOT see 'abc' in the field?",
				test:function(t){
					dohx.showInfo('<form><input type="time" value="abc" /></form>');
				}
			},
//*/
		]
