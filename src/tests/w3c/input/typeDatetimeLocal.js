...
//imho this test/question is tooo subjective ... i am not sure if this belongs here like this
			...
			}, 
			{
				...
				test:function(t){
					dohx.showInfo('<form><input  id="_input400" type="datetime-local" /></form>');
...
//				],
//				test:function(t){
//					dohx.showInfo('<form id="_form500"><input type="datetime-local" /><input type="submit" /></form>');
...
//			}
			{
				...
				expectedResult: "Do you NOT see 'abc' in the field?",
				test:function(t){
					dohx.showInfo('<form><input type="datetime-local" value="abc" /></form>');
				}
			},
//*/
		]
