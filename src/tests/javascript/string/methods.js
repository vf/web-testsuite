(function(){
	...
	dohx.add({name:"string methods",
		...
		tests:[
			...
			// charAt
			//
			javascriptUtil.getExistsTest({id:100, object:"", property:"charAt", expectedType:"", specs:[]}),
			javascriptUtil.getTypeCheckTest({id:101, object:"", property:"charAt", expectedType:"function", dependsOn:[100], specs:[]}),
			
			//
			// charCodeAt
			//
			javascriptUtil.getExistsTest({id:200, object:"", property:"charCodeAt", expectedType:"", specs:[]}),
			javascriptUtil.getTypeCheckTest({id:210, object:"", property:"charCodeAt", expectedType:"function", dependsOn:[200], specs:[]}),
			
			//
			// concat
			//
			javascriptUtil.getExistsTest({id:300, object:"", property:"concat", expectedType:"", specs:[]}),
			...
			//
			javascriptUtil.getExistsTest({id:400, object:"", property:"indexOf", expectedType:"", specs:[]}),
